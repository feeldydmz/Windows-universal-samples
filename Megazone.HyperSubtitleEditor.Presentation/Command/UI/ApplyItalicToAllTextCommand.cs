...
{
    public class ApplyItalicToAllTextCommand : DependencyObject, ICommand
    {
        private readonly SubtitleViewModel _subtitleViewModel;

        public ApplyItalicToAllTextCommand()
        {
        ...
        {
            MessageCenter.Instance.Send(new SubtitleView.ApplyItalicToAllTextMessage(this));
        }
