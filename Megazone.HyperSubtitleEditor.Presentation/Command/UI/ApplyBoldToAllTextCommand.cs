...
{
    public class ApplyBoldToAllTextCommand : DependencyObject, ICommand
    {
        private readonly SubtitleViewModel _subtitleViewModel;

        public ApplyBoldToAllTextCommand()
        {
        ...
        {
            MessageCenter.Instance.Send(new SubtitleView.ApplyBoldToAllTextMessage(this));
        }
