...
namespace Megazone.Cloud.Media.Domain.Assets
{
    ...
    {
        public RenditionAsset(string id, string name, string status, string type, string mediaType, long duration, int version, string createdAt, IEnumerable<string> urls, IEnumerable<Rendition> elements)
