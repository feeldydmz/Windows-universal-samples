...
namespace Megazone.AtomyExcelConverter.Presentation.Infrastructure.View
{
    ...
    public partial class ConfirmWindow : Window
    {
        ...
        private readonly IList<CustomButtonSetting> _buttonContents = new List
            <CustomButtonSetting>
            {
                new CustomButtonSetting(MessageBoxResult.OK, "확인", ButtonRunTypes.Default),
                new CustomButtonSetting(MessageBoxResult.Cancel, "취소", ButtonRunTypes.Cancel),
        ...
        {
            get { return (IList<ButtonInfo>)GetValue(ButtonsProperty); }
